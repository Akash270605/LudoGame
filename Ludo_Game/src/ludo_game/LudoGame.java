...
public class LudoGame extends JFrame implements ActionListener{
    ...
    LudoGame(String title)
    {
        ...
        newgame.setIcon(new ImageIcon("src/ludo_game/Webp.net-resizeimage (23).png"));
        newgame.addActionListener(this);
        
        dicebutton= new JButton("DICE");
        add(dicebutton);
        dicebutton.setBounds(620,290,170,50);
        dicebutton.setIcon(new ImageIcon("src/ludo_game/dice.png"));
    ...
    public void paint(Graphics g){
        blank = new ImageIcon("src/ludo_game/blankdice.png");
        
        img= new ImageIcon("src/ludo_game/Webp.net-resizeimage (1).jpg");
        ...
        if(!start)
        {
            ...
            start = true;
            img2= new ImageIcon("src/ludo_game/Webp.net-resizeimage (3).jpg");
        ...
        star= new ImageIcon("src/ludo_game/star.png");
        ...
        iplayer1_1= new ImageIcon("src/ludo_game/redplayer.png");
        iplayer1_2= new ImageIcon("src/ludo_game/redplayer.png");
        iplayer1_3= new ImageIcon("src/ludo_game/redplayer.png");
        iplayer1_4= new ImageIcon("src/ludo_game/redplayer.png");
        ...
        iplayer2_1= new ImageIcon("src/ludo_game/greenplayer.png");
        iplayer2_2= new ImageIcon("src/ludo_game/greenplayer.png");
        iplayer2_3= new ImageIcon("src/ludo_game/greenplayer.png");
        iplayer2_4= new ImageIcon("src/ludo_game/greenplayer.png");
	...
	if(player2_2==false)
		...
		if(player2 && moves==1 )
		{
			...
			if(pos24==pos22 && pos24==pos23 && pos24==pos21 && player2_1 && player2_4&& player2_2 && player2_3&&!win24)
			{
                ...
                iplayer3_1= new ImageIcon("src/ludo_game/yellowplayer.png");
                iplayer3_2= new ImageIcon("src/ludo_game/yellowplayer.png");
                iplayer3_3= new ImageIcon("src/ludo_game/yellowplayer.png");
                iplayer3_4= new ImageIcon("src/ludo_game/yellowplayer.png");
		...
		if(player3 && moves==1 )
		{
			...
			if(pos34==pos32 && pos34==pos33 && pos34==pos31 && player3_1 && player3_4&& player3_2 && player3_3&&!win34)
			{
                ...
                iplayer4_1= new ImageIcon("src/ludo_game/blueplayer.png");
                iplayer4_2= new ImageIcon("src/ludo_game/blueplayer.png");
                iplayer4_3= new ImageIcon("src/ludo_game/blueplayer.png");
                iplayer4_4= new ImageIcon("src/ludo_game/blueplayer.png");
		...
		if(player4 && moves==1 )
		{
			...
			if(pos44==pos32 && pos44==pos43 && pos44==pos41 && player4_1 && player4_4&& player4_2 && player4_3&&!win44)
			{
                ...
                ifirst= new ImageIcon("src/ludo_game/1st.png");
                isecond= new ImageIcon("src/ludo_game/2nd.png");
                ithird = new ImageIcon("src/ludo_game/3rd.png");
                iforth = new ImageIcon("src/ludo_game/4th.png");
                ...
                if(randomnum == 1){
                    label.setIcon(new ImageIcon("src/ludo_game/dice1.png"));
                }
                else if(randomnum == 2){
                    label.setIcon(new ImageIcon("src/ludo_game/dice2.png"));
                }
                else if(randomnum==3){
                    label.setIcon(new ImageIcon("src/ludo_game/dice3.png"));
                }
                else if(randomnum == 4){
                    label.setIcon(new ImageIcon("src/ludo_game/dice4.png"));
                }
                
                else if(randomnum == 5){
                    label.setIcon(new ImageIcon("src/ludo_game/dice5.png"));
                }
                else if(randomnum == 6){
                    label.setIcon(new ImageIcon("src/ludo_game/dice6.png"));
                }
                
                if(moves == 0){
                    if(player2 && (player1_1 || player1_2 || player1_3 || player1_4)){
                        label.setIcon(new ImageIcon("src/ludo_game/blankdice.png"));
                    }
        ...
        if(e.getSource() == runner1 && moves ==1){
            if(player1){
                if(player1_1){
                    ...
                    if(!win11 && pos11 !=8 && pos11 != 21 && pos11 !=34 && pos11 != 47 && pos11 !=13 && pos11 !=26 && pos11 != 39 && pos11 <56)
                    {
    ...
    public static void main(String[] args){
        LudoGame l = new LudoGame("Ludo Game");
    }
}
